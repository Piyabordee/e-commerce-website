        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                <div className="h-40 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl mb-4"></div>
                <h3 className="font-bold text-gray-900 mb-2">สินค้าแนะนำ {i}</h3>
                <p className="text-blue-600 font-bold">฿XXX</p>
              </div>
            ))}
          </div>
        </section>
